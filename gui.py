...
def find_duplicates(folder_path, min_size=0, max_size=None):
    """Busca archivos duplicados en una carpeta utilizando multithreading."""
    hashes = {}
    duplicates = []

    print(f"Escaneando la carpeta: {folder_path}...")
...
class DuplicateFinderApp:
    def __init__(self, root):
        ...
        self.folder_label = tk.Label(self.root, text="Selecciona la carpeta:", font=("Arial", 12), bg="#f4f4f4")
    ...
    def select_folder(self):
        ...
        if self.folder_path:
            print(f"Carpeta seleccionada: {self.folder_path}")
    ...
    def find_duplicates(self):
        ...
        try:
            ...
            self.duplicates = find_duplicates(self.folder_path, min_size, max_size)
